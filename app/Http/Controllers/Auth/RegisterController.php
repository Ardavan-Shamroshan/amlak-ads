...
class RegisterController {
    ...
    public function register() {
        ...
        User::create($inputs);
        $message = '<h2>ایمیل فعال سازی</h2>
            <p>کاربر گرامی ثبت نام شما با موفقیت صورت گرفت. برای فعال سازی حساب کاربری خود برروی لینک زیر کلیک کنید.
            <br>
            <a href="' . route('auth.activation', [$inputs['verify_token']]) . '">
