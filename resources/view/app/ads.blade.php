            ...
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate text-center">
                    <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">
                        <span class="mr-2"><a href="index.html">خانه</a></span> <span class="mr-2"><a href="blog.html">آگهی ها</a></span>
                        <span>آگهی</span></p>
        ...
        <div class="container">
            <div class="row">
                        ...
                        <div class="col-md-12 Properties-single mt-4 mb-5 ftco-animate">
                            ...
                            <div class="d-md-flex mt-5 mb-5" dir="rtl">
                                ...
                                <ul class="ml-md-5" dir="rtl">
                                    ...
                                    <li><span>بالکن : </span> <?= $advertise->balcony == 0 ? 'دارد' : 'ندارد' ?></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 ftco-animate">
                                    <div class="properties">
                                        ...
                                        <div class="text p-3">
                                            <span class="status <?= $advertise->sellStatus() == 'اجاره' ? 'rent' : 'sale'; ?>"><?= $advertise->sellStatus() ?></span>
                                            <div class="d-flex">
                                                <div class="one">
                                                    <h3>
                ...
                <div class="col-lg-4 sidebar ftco-animate">
                    ...
                    <div class="sidebar-box ftco-animate">
                        <h3>اخرین بلاگ ها</h3><h3>اخرین بلاگ ها</h3>
